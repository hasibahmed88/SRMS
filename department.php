		...
		<div class="col-12 border">
			<div class="row justify-content-center">
				<div class="col-12 col-md-6 p-3 border my-4">
					<h6>Select department for view students</h6>
					<br>
					<form action="department_student.php" method="POST">
						...
						<div class="form-group">
							<input type="submit" name="department_btn" value="Submit" class="btn btn-success btn-sm">
						</div>
					</form>
				</div>
			</div>
